...
inline const std::vector<std::pair<SceSystemParamLang, std::string>> LIST_SYS_LANG = {
    { SCE_SYSTEM_PARAM_LANG_DANISH, "丹麦语" },
    { SCE_SYSTEM_PARAM_LANG_GERMAN, "德语" },
    { SCE_SYSTEM_PARAM_LANG_ENGLISH_GB, "英语" },
    { SCE_SYSTEM_PARAM_LANG_ENGLISH_US, "美语" },
    { SCE_SYSTEM_PARAM_LANG_SPANISH, reinterpret_cast<const char *>(u8"西班牙语") },
    { SCE_SYSTEM_PARAM_LANG_FRENCH, reinterpret_cast<const char *>(u8"法语") },
    { SCE_SYSTEM_PARAM_LANG_ITALIAN, "意大利语" },
    { SCE_SYSTEM_PARAM_LANG_DUTCH, "荷兰语" },
    { SCE_SYSTEM_PARAM_LANG_NORWEGIAN, "挪威语" },
    { SCE_SYSTEM_PARAM_LANG_POLISH, "波兰语" },
    { SCE_SYSTEM_PARAM_LANG_PORTUGUESE_BR, reinterpret_cast<const char *>(u8"巴西葡萄牙语") },
    { SCE_SYSTEM_PARAM_LANG_PORTUGUESE_PT, reinterpret_cast<const char *>(u8"葡萄牙语") },
    { SCE_SYSTEM_PARAM_LANG_RUSSIAN, reinterpret_cast<const char *>(u8"俄语") },
    { SCE_SYSTEM_PARAM_LANG_FINNISH, "芬兰语" },
    { SCE_SYSTEM_PARAM_LANG_SWEDISH, "瑞典语" },
    { SCE_SYSTEM_PARAM_LANG_TURKISH, reinterpret_cast<const char *>(u8"土耳其语") },
    { SCE_SYSTEM_PARAM_LANG_JAPANESE, reinterpret_cast<const char *>(u8"日语") },
    { SCE_SYSTEM_PARAM_LANG_KOREAN, "韩语" },
    { SCE_SYSTEM_PARAM_LANG_CHINESE_S, reinterpret_cast<const char *>(u8"简体中文") },
    { SCE_SYSTEM_PARAM_LANG_CHINESE_T, reinterpret_cast<const char *>(u8"繁体中文") },
};
