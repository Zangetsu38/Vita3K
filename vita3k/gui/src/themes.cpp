    ...
    if (content_id != "default") {
        ...
        if (doc.load_file(THEME_XML_PATH.c_str())) {
            ...
            if (!home_property.empty()) {
                ...
                if (!home_property.child("m_friend").child("m_iconFilePath").text().empty())
                    theme_icon_name["NPXS10006"] = home_property.child("m_friend").child("m_iconFilePath").text().as_string();
                ...
                if (!home_property.child("m_settings").child("m_iconFilePath").text().empty())
                    theme_icon_name["NPXS10014"] = home_property.child("m_message").child("m_iconFilePath").text().as_string();
                if (!home_property.child("m_message").child("m_iconFilePath").text().empty())
